  ...
  return (
    <div className="sticky top-0 z-10 bg-white border-b border-slate-100 px-8 py-4">
      <div className="max-w-[1600px] mx-auto space-y-4">
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3 flex-1 min-w-0">
            ...
            <Input
              ...
              className="text-xl font-bold border-0 bg-transparent px-0 focus-visible:ring-0 focus-visible:ring-offset-0 h-auto py-1 hover:bg-slate-50 rounded transition-colors text-slate-800 placeholder:text-slate-300 w-full max-w-4xl"
        ...
        {/* Bottom Row: Selects (aligned with title) */}
        <div className="flex items-center gap-2 pl-14"> {/* Indentation to align with title text */}
