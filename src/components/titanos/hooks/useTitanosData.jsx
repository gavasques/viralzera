...
export function useApprovedModels() {
  return useQuery({
    ...
    queryFn: () => neon.entities.ApprovedModel.list('order', 100),
...
export function useTitanosGroups() {
  return useQuery({
    ...
    queryFn: () => neon.entities.TitanosChatGroup.list('order', 50),
...
export function useTitanosConversations(limit = DEFAULT_CONVERSATION_LIMIT) {
  return useQuery({
    ...
    queryFn: () => neon.entities.TitanosConversation.list('-created_date', limit),
...
export function useTitanosConversation(conversationId) {
  return useQuery({
    ...
    queryFn: () => neon.entities.TitanosConversation.get(conversationId),
...
export function useTitanosMessages(conversationId) {
  return useQuery({
    ...
    queryFn: () => neon.entities.TitanosMessage.filter({ conversation_id: conversationId }),
    enabled: !!conversationId,
...
export function useConversationVotes(conversationId) {
  return useQuery({
    ...
    queryFn: () => neon.entities.ModelVote.filter({ conversation_id: conversationId }),
    enabled: !!conversationId,
