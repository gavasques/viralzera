...
export default function CanvasFolderSidebar({ selectedFolderId, onSelectFolder }) {
    ...
    const createMutation = useMutation({
        mutationFn: (data) => neon.entities.CanvasFolder.create(data),
        onSuccess: () => {
    ...
    const updateMutation = useMutation({
        mutationFn: ({ id, data }) => neon.entities.CanvasFolder.update(id, data),
        onSuccess: () => {
            queryClient.invalidateQueries({ queryKey: ['canvasFolders'] });
    ...
    const deleteMutation = useMutation({
        mutationFn: (id) => neon.entities.CanvasFolder.delete(id),
        onSuccess: () => {
            queryClient.invalidateQueries({ queryKey: ['canvasFolders'] });
