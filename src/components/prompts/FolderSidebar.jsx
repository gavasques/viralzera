...
export default function FolderSidebar({ selectedFolderId, onSelectFolder }) {
    ...
    const { data: rawFolders = [] } = useQuery({
        ...
        queryFn: () => neon.entities.PromptFolder.list('name', 100),
    });
    ...
    const createMutation = useMutation({
        mutationFn: (data) => neon.entities.PromptFolder.create(data),
        onSuccess: () => {
    ...
    const updateMutation = useMutation({
        mutationFn: ({ id, data }) => neon.entities.PromptFolder.update(id, data),
        onSuccess: () => {
            queryClient.invalidateQueries({ queryKey: ['promptFolders'] });
    ...
    const deleteMutation = useMutation({
        mutationFn: (id) => neon.entities.PromptFolder.delete(id),
        onSuccess: () => {
            queryClient.invalidateQueries({ queryKey: ['promptFolders'] });
