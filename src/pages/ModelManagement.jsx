...
// fetchModels removed - calling neon.functions directly to avoid initialization issues
...
export default function ModelManagement() {
  ...
  const toggleActiveMutation = useMutation({
    mutationFn: async ({ id, isActive }) => {
      await neon.entities.ApprovedModel.update(id, { is_active: isActive });
    },
    onSuccess: () => {
  ...
  const deleteMutation = useMutation({
    mutationFn: async (id) => {
      await neon.entities.ApprovedModel.delete(id);
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['approvedModels'] });
