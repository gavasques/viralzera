...
export default function PersonaGenerator() {
  ...
  const { data: sessions = [], isLoading } = useQuery({
    ...
    queryFn: () => neon.entities.PersonaChat.filter(
  ...
  const createMutation = useMutation({
    mutationFn: (data) => neon.entities.PersonaChat.create(data),
  ...
  const updateMutation = useMutation({
    mutationFn: ({ id, data }) => neon.entities.PersonaChat.update(id, data),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['personaChats'] });
    }
  });
  ...
  const deleteMutation = useMutation({
    mutationFn: (id) => neon.entities.PersonaChat.delete(id),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['personaChats'] });
  ...
  const renameMutation = useMutation({
    mutationFn: ({ id, title }) => neon.entities.PersonaChat.update(id, { title }),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['personaChats'] });
  ...
  const favoriteMutation = useMutation({
    mutationFn: ({ id, is_favorite }) => neon.entities.PersonaChat.update(id, { is_favorite }),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['personaChats'] });
    }
  });
