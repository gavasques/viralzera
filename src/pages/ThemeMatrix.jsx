...
export default function ThemeMatrix() {
  ...
  const saveMutation = useMutation({
    mutationFn: (data) => {
      ...
      if (editingTheme) return neon.entities.Theme.update(editingTheme.id, { title: data.title });
      return neon.entities.Theme.create(payload);
    },
    onSuccess: () => {
  ...
  const deleteMutation = useMutation({
    mutationFn: async (id) => {
      ...
      return neon.entities.Theme.delete(id);
    },
    onSuccess: () => {
