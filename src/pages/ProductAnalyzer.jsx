...
export default function ProductAnalyzer() {
  ...
  const { data: sessions = [], isLoading } = useQuery({
    ...
    queryFn: () => neon.entities.ProductChat.filter(
  ...
  const createMutation = useMutation({
    mutationFn: (data) => neon.entities.ProductChat.create(data),
  ...
  const updateMutation = useMutation({
    mutationFn: ({ id, data }) => neon.entities.ProductChat.update(id, data),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['productChats'] });
    }
  });
  ...
  const deleteMutation = useMutation({
    mutationFn: (id) => neon.entities.ProductChat.delete(id),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['productChats'] });
  ...
  const renameMutation = useMutation({
    mutationFn: ({ id, title }) => neon.entities.ProductChat.update(id, { title }),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['productChats'] });
  ...
  const favoriteMutation = useMutation({
    mutationFn: ({ id, is_favorite }) => neon.entities.ProductChat.update(id, { is_favorite }),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['productChats'] });
    }
  });
