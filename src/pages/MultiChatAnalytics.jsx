...
export default function MultiChatAnalytics() {
    ...
    const { data: conversations = [] } = useQuery({
        ...
        queryFn: () => neon.entities.TitanosConversation.list('-created_date', 500),
    });
    ...
    const { data: allMessages = [] } = useQuery({
        ...
        queryFn: async () => {
            const msgs = await neon.entities.TitanosMessage.list('-created_date', 5000);
            return msgs;
        },
    });
    ...
    const { data: allVotes = [] } = useQuery({
        queryKey: ['modelVotes'],
        queryFn: () => neon.entities.ModelVote.list('-created_date', 1000),
    });
