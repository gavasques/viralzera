...
export default function Layout({ children }) {
  ...
  const { data: user, isLoading: isLoadingUser } = useQuery({
    ...
    queryFn: () => neon.auth.me().catch(() => null),
        ...
        <div className="flex justify-center mb-8">
          {collapsed ? (
            ...
            <div className="flex flex-col items-center gap-1">
              ...
              <span className="text-xl font-bold bg-gradient-to-r from-pink-600 to-rose-600 bg-clip-text text-transparent tracking-tight">
                Viralzera
              </span>
            </div>
          )}
    ...
    <div className="min-h-screen bg-slate-50/50 flex font-sans text-slate-900">
      ...
      <div className="md:hidden fixed top-0 w-full z-20 bg-white/80 backdrop-blur-md border-b border-slate-200 p-4 flex justify-between items-center">
        <div className="flex items-center gap-2">
          ...
          <span className="text-base font-bold bg-gradient-to-r from-pink-600 to-rose-600 bg-clip-text text-transparent tracking-tight">
            Viralzera
          </span>
        </div>
        ...
        {selectedFocusId || allFocuses.length === 0 ? (
          ...
          <div className="flex flex-col items-center justify-center min-h-[60vh] text-center space-y-6">
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 mb-4">
              <div className="bg-gradient-to-br from-pink-500 to-rose-600 p-4 rounded-2xl inline-flex shadow-md">
