...
export default function AudienceChat() {
  ...
  const { data: sessions = [], isLoading } = useQuery({
    ...
    queryFn: () => neon.entities.AudienceChat.filter(
  ...
  const { data: personas = [] } = useQuery({
    ...
    queryFn: () => neon.entities.Persona.filter({ focus_id: selectedFocusId }),
    enabled: !!selectedFocusId
  });
  ...
  const { data: products = [] } = useQuery({
    ...
    queryFn: () => neon.entities.Product.filter({ focus_id: selectedFocusId }),
    enabled: !!selectedFocusId
  });
  ...
  const createMutation = useMutation({
    mutationFn: (data) => neon.entities.AudienceChat.create(data),
  ...
  const updateMutation = useMutation({
    mutationFn: ({ id, data }) => neon.entities.AudienceChat.update(id, data),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['audienceChats'] });
    }
  });
  ...
  const deleteMutation = useMutation({
    mutationFn: (id) => neon.entities.AudienceChat.delete(id),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['audienceChats'] });
  ...
  const renameMutation = useMutation({
    mutationFn: ({ id, title }) => neon.entities.AudienceChat.update(id, { title }),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['audienceChats'] });
  ...
  const favoriteMutation = useMutation({
    mutationFn: ({ id, is_favorite }) => neon.entities.AudienceChat.update(id, { is_favorite }),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['audienceChats'] });
    }
  });
